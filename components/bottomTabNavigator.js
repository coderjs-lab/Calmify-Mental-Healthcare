...
import MessageNotification from '../screens/MessageScreen';
...
export const bottomTabNavigator = createMaterialBottomTabNavigator({
    ...
    MessageScreen : {
        ...
        navigationOptions :{
        tabBarIcon : ({ tintColor, focused }) => <Icon name="sms" type="font-awesome-5" size={24} color={tintColor} focused={true}/>,
        tabBarLabel : <Text style={{ fontSize: 12, textAlignVertical:"bottom", textAlign: 'center'}}>Message</Text>
        }
    }
},
{
